...
const paths: Record<IconName, ReactElement> = {
  ...
  trash: (
    <>
      <Path d="M4.5 7h15" />
      <Path d="M9.5 7V4.8A1.8 1.8 0 0 1 11.3 3h1.4a1.8 1.8 0 0 1 1.8 1.8V7" />
      <Path d="M6.8 7l.9 12a2.1 2.1 0 0 0 2.1 2h4.4a2.1 2.1 0 0 0 2.1-2l.9-12" />
      <Path d="M10.2 11.2v5.6M13.8 11.2v5.6" />
    </>
  ),
  // 时钟：表盘 + 指针
  clock: (
  ...
  photo: (
    <>
      ...
      <Circle cx={9.2} cy={9.8} r={1.7} />
      <Path d="m4.8 17.2 4.2-4.2a1.7 1.7 0 0 1 2.4 0l4.2 4.2" />
      <Path d="m14.4 14.6 1.6-1.6a1.7 1.7 0 0 1 2.4 0l1.8 1.8" />
    </>
  ),
  // 笑脸（心情）
  mood: (
    <>
      <Circle cx={12} cy={12} r={8.5} />
      <Path d="M8.6 14a4.4 4.4 0 0 0 6.8 0" />
      <Path d="M9.2 10h.01M14.8 10h.01" />
    </>
  ),
  // 餐具：叉 + 刀
  food: (
    <>
      ...
      <Path d="M8 3v7" />
      <Path d="M8 10v11" />
      <Path d="M15.5 3c2.9 1.7 4 4.7 4 8 0 2.6-1.2 4-4 4" />
      <Path d="M15.5 3v18" />
    </>
  ),
  // 定位图钉
  location: (
    <>
      <Path d="M19 10.2c0 5.1-7 10.6-7 10.6S5 15.3 5 10.2a7 7 0 0 1 14 0Z" />
      <Circle cx={12} cy={10} r={2.5} />
    </>
  ),
  // 五角星
  star: (
    <Path d="m12 3.6 2.5 5.1 5.6.8-4 3.9.9 5.6-5-2.6-5 2.6.9-5.6-4-3.9 5.6-.8L12 3.6Z" />
  ),
  // 人物：头像 + 肩线
  person: (
    <>
  ...
  edit: (
    <>
      <Path d="M11.5 4.5H6.8a3.3 3.3 0 0 0-3.3 3.3v9.4a3.3 3.3 0 0 0 3.3 3.3h9.4a3.3 3.3 0 0 0 3.3-3.3v-4.7" />
      <Path d="M17.6 3.9a2.05 2.05 0 0 1 2.9 2.9L12 15.3l-3.9 1 1-3.9 8.5-8.5Z" />
    </>
  ),
  // 关闭叉
  close: (
  ...
  ticket: (
    <>
      <Path d="M3 9.2a2.8 2.8 0 0 1 0 5.6v2.4a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-2.4a2.8 2.8 0 0 1 0-5.6V6.8a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v2.4Z" />
      <Path d="M13.5 5.2v1.8" />
      <Path d="M13.5 11.1v1.8" />
      <Path d="M13.5 17v1.8" />
    </>
  ),
  // 购物袋：袋身 + 提手
  bag: (
    <>
      <Path d="M5.6 7.5h12.8l-1.1 11a2.3 2.3 0 0 1-2.3 2.1H9a2.3 2.3 0 0 1-2.3-2.1l-1.1-11Z" />
